        ...
        <div className="max-w-7xl mx-auto">
          ...
          <header className="text-center mb-16 animate-fade-in">
            ...
            <h1 className="lg:text-6xl md:text-5xl text-3xl font-bold mb-1 bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 bg-clip-text text-transparent">
              Safety Resources <span><div className="inline-flex items-center justify-center  lg:w-24 lg:h-24 md:w-22 md:h-22 w-16 h-16 ml-6 rounded-full bg-gradient-to-br from-purple-500/20 to-pink-500/20 mb-2">
